        ...
        for attempt in range(1, self.max_retries + 1):
            try:
                ...
                if current_set:
                    ...
                    # DataConnect é definido apenas na primeira conexão e não deve ser atualizado
                    ...
                    logger.debug(f"Sincronizados {len(current_set)} jogadores na tabela players_online")
